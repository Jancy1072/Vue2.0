// actions types
export const FETCH_NEWS_LATEST = 'FETCH_NEWS_LATEST'                // 最新消息列表
export const FETCH_NEWS_LATEST_MORE = 'FETCH_NEWS_LATEST_MORE'      // 更多消息
export const FETCH_NEWS_DETAIL = 'FETCH_NEWS_DETAIL'                // 详细信息
export const FETCH_THEMES = 'FETCH_THEMES'                          // 日报主题
export const FETCH_THEME_LIST = 'FETCH_THEME_LIST'                // 日报主题进去的列表
...
export const TOGGLE_THEME_LIST = 'TOGGLE_THEME_LIST'              // 日报主题进去的列表    
...
export const DONE_THEME_LIST = 'DONE_THEME_LIST'                  // 日报主题进去的列表    
